import { View, Image, StyleSheet, Text, GestureResponderEvent, useWindowDimensions, ScrollView } from 'react-native';
...
interface GameOverScreenProps {
	roundsNumber: number;
	userNumber: number;
	onStartNewGame?: ((event: GestureResponderEvent) => void) | undefined;
}
